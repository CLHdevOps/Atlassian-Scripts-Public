...
//Returns usernames and email addresses
///////////////////////////////////////////////////
...
@ShortTextInput(description = 'Internal Directory: 1<br>External Directory: 12345', label = 'Enter the first Directory ID which has most users')
String directoryId1
 
@ShortTextInput(description = 'Internal Directory: 1<br>External Directory: 12345', label = 'Enter the second Directory ID which has least users')
String directoryId2
