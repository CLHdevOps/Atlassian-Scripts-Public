...
//Last Modified: 19th Mar 2023 - 01:02 pm
////////////////////////////////////////
...
for(int i=0;i<userNameStringsarray.size();)
{
  try
  {
    if (userManager.getUserByName(userNameStringsarray[i])&&(userManager.getUserByName(userNameStringsarray[i]).getDirectoryId()==directoryId.toLong()))
    {
