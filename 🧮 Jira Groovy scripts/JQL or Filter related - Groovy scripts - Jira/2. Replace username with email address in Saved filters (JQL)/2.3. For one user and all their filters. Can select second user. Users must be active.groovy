...
//user picker to verify if the user already exists
@UserPicker(description = '', label = 'User to replace', multiple = false)
ApplicationUser replaceuser
...
def newQueryString = jqlQuery.replace(replaceuser.getUsername(),'"'+replaceuser.getEmailAddress()+'"')
